    ...
    <div className="max-w-4xl space-y-6">
      ...
      <div className="grid grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-xl shadow-sm border">
          ...
          <div className="mt-4">
            <Link href="/dashboard/deposit" className="text-sm bg-blue-600 text-white px-4 py-2 rounded-md font-medium hover:bg-blue-700">
              Nạp thêm
            </Link>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border">
          ...
          <div className="text-3xl font-bold mt-2 text-indigo-600">
            {credits?.find(c => c.product_code === 'AI_CREDIT')?.balance || 0} <span className="text-lg">Tín chỉ</span>
          </div>
          <div className="mt-4">
